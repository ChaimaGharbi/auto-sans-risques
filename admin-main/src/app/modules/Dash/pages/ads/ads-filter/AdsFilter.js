...
export function AdsFilter({ listLoading }) {
  // AdsUI Context
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(adsUIProps.queryParams, values);
    if (!isEqual(newQueryParams, adsUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      adsUIProps.setQueryParams(newQueryParams);
    }
  };
