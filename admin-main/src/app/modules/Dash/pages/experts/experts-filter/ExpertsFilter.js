...
export function ExpertsFilter({ listLoading }) {
  // Experts UI Context
  ...
  const applyFilter = (values) => {
    const newQueryParams = prepareFilter(expertsUIProps.queryParams, values);
    if (!isEqual(newQueryParams, expertsUIProps.queryParams)) {
      newQueryParams.pageNumber = 1;
      // update list by queryParams
      expertsUIProps.setQueryParams(newQueryParams);
    }
  };
