...
export function ArticlesGrouping() {
  ...
  const articlesUIProps = useMemo(() => {
    return {
      ...
      opendeleteModelsDialog: articlesUIContext.opendeleteModelsDialog,
      openfetchModelsDialog: articlesUIContext.openfetchModelsDialog,
    };
  }, [articlesUIContext]);
          ...
          <div className="form-group form-group-inline">
            ...
            <div className="form-group-inline">
              <button
                ...
                onClick={articlesUIProps.opendeleteModelsDialog}
              >
