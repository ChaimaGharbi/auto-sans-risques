...
import { CategoryStatusCssClasses } from "../MarksUIHelpers";
import * as actions from "../../../_redux/marks/categoriesActions";
  ...
  const { categories, isLoading } = useSelector(
    (state) => ({
      categories: selectedCategories(
        state.marks.entities,
        categoriesUIProps.ids
      ),
      isLoading: state.marks.actionsLoading,
    }),
    shallowEqual
  );
