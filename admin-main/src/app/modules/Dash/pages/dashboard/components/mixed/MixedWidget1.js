...
export function MixedWidget1({ className,todayRevenue,todayClients,todayExperts,todayMissions }) {
  ...
  return (
    <div className={`card card-custom bg-gray-100 ${className}`}>
      ...
      <div className="card-header border-0 bg-danger py-5">
        <h3 className="card-title font-weight-bolder text-white">Statistiques d'aujourd'hui</h3>
      </div>
      {/* Body */}
