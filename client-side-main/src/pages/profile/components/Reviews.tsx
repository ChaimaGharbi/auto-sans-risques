...
import { useGetReviews, useMoreReviews } from 'app/store/hooks'
...
const Reviews = () => {
  ...
  return (
    <div className="bg-white col-span-2 border-t p-6 lg:p-10">
      <div className="grid xxs:flex items-center justify-between py-4">
