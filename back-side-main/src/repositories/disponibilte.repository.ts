...
import { DisponibiliteDto } from 'src/modules/disponibilite/dto/disponibilite.dto';

export class DisponibiliteRepository {
  constructor(
    @InjectModel(Disponibilite.name) private disponibiliteModel: Model<Disponibilite>,
